...
public class AddFormRequest implements Serializable{
	...
	public Integer getNightRun() {
		return nightRun;
	}
	public void setNightRun(Integer nightRun) {
		this.nightRun = nightRun;
	}
	public Integer getDayRun() {
		return dayRun;
	}
	public void setDayRun(Integer dayRun) {
		this.dayRun = dayRun;
	}
